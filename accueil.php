              ...
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.9s">
                <form class="form-inline">
                  <div class="form-group">
                    <button type="livedemo" name="Live Demo" class="btn btn-primary btn-lg" required="required"><a href="connexion.php" style="color : white;">Se connecter</a></button>
                  </div>
                  <div class="form-group">
                    <button type="getnow" name="Get Now" class="btn btn-primary btn-lg" required="required"><a href="inscription.php" style="color : #3498BD;">S'inscrire</a></button>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
            ...
            <form action="" method="post" role="form" class="contactForm">
              ...
              <button type="submit" class="btn btn-theme pull-left">Envoyer un message</button>
            </form>
          </div>
        </div>
      </div>
